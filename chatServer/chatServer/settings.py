...
SECRET_KEY = 'django-insecure-tix=b$4*y-k*id05ykw4uksd2e64+(&!vpdvgu@ih_46td6!%-'
...
CHANNEL_LAYERS = {
    'default': {
        'BACKEND': 'channels_redis.core.RedisChannelLayer', # Using Redis as the channel layer backend
        'CONFIG': {
